!(function () {
  ...
  var H = "__test_storage_support__",
    ...
    V = function (e) {
      ...
      try {
        ...
        return t.setItem(H, W), t.getItem(H) !== W ? !1 : (t.removeItem(H), !0);
      } catch (e) {
        return !1;
      }
    },
  ...
  const Y = /[^:]+:\/\/[^(/|?)\s]+/,
    ...
    ne = (e) => e.replace(/\w/g, "$&[\\r\\n\\t]*"),
    ie =
      (RegExp("^[\0-]*(" + ne("javascript") + "|" + ne("data") + "):", "i"),
      /^((http(s)?:)?\/\/)/),
    oe = /^((http(s)?:)?\/\/)/,
    re = (e) => {
      const t = e.match(oe);
    ...
    le = () => {
      return (
        ...
        Z(t)[e] || (V("session") && !!window.sessionStorage.getItem(se))
      );
      var e, t;
    };
  var de = (e) => (t, n) => {
          ...
          return (
            ...
            e(0, (e, t) =>
              0 === e
                ? ((r = t), void r(1))
                : 1 === e
                ? ((c = void 0), r(2), o(2), void (a && i(2)))
                : void (
                    2 === e && ((r = null), t && ((c = t), o(2), a && i(e, t)))
                  )
            ),
            (a = !0),
            i(0, (e, t) => {
  ...
  const qe = (e, t) => t,
    ...
    We = je(
      [(e, t) => He(e, t).events.orderedIds, (e, t) => He(e, t).events.byIds],
      (e, t) => e.map((e) => t[e])
    )(qe),
    Ve = je([He, We], (e, t) => ({ ...e, events: t }))(qe),
  ...
  const Qe = () => !!document.documentElement.currentStyle,
    Ze = (e, t) => {
      const i = window.getComputedStyle(t),
        o = "border-box" === i.boxSizing,
        r = A(e, i);
      if (Qe() && o && n("width", r) && null !== r.width) {
        r.width =
          P(
            [
              r.width,
      ...
      if (Qe() && o && n("height", r) && null !== r.height) {
        r.height =
          P(
            [
              r.height,
  ...
  const nt = (e, t) => {
    ...
    st = { opacity: 0, visibility: "hidden", zIndex: -1 },
    lt = { opacity: 1, visibility: "visible", zIndex: 2147483639 },
    dt = {
      id: it + "-container",
      style: {
        ...st,
    ...
    ht = { alt: "", style: { display: "block", border: 0, float: "right" } },
    ft = {
      position: "absolute",
      top: "0px",
      left: "0px",
  ...
  const Et = /\.(\w+)$/i,
    xt = new Audio(),
    It = { mp3: "audio/mpeg", ogg: "audio/ogg" },
    Lt = (e) => {
      const t = ((e) => {
        const t = e.match(Et);
  ...
  const Ot = () => {
    ...
    St = { isBridgeActive: !1, isIframeActive: null, hasIframeUnlocked: !1 },
    ...
    Dt = () =>
      _(navigator.platform, [
        ...
        "iPhone",
        "iPod",
      ]) && _("Version/15", navigator.userAgent),
    Ft = () =>
      /mobile/gi.test(navigator.userAgent) &&
      !("MacIntel" === navigator.platform && _("iPad", navigator.userAgent)),
    ...
    qt = (e, t) => Je(e, "visibility").state === t;
  !(function (e) {
    const t = (function (e) {
      try {
  ...
  function Kt(e, t) {
    ...
    return new Promise((t, r) => {
      et().then((a) => {
        ...
        const l = "__" + s;
        (window[l] = (e) => {
          delete Ut[s], delete window[l], tt(c), t(e);
        }),
          (c.src = e + "?" + G({ ...n, [i]: l })),
  ...
  const Yt = /\.([a-z]{1,})$/i,
    ...
    Xt = (e) => {
      var t;
      return { "x-region": null != (t = e.region) ? t : "" };
    },
    $t = (e) => {
      let { region: t } = e;
      return (
    ...
    Zt = function (e, t) {
      ...
      return Kt(Qt("get_dynamic_configuration", e), {
        query: {
          ...Xt(e),
          ...(e.organizationId ? { organization_id: e.organizationId } : {}),
          ...(e.licenseId ? { license_id: e.licenseId } : {}),
          client_id:
        ...
        if (t.error)
          switch (t.error.type) {
            case "misdirected_request":
              return Zt({ ...e, region: t.error.data.region });
        ...
        if (
          ((19196658 !== e.licenseId &&
            "4c8c0751-837f-4a11-928e-047b2d095307" !== e.organizationId) ||
            (t.default_widget = "livechat"),
    ...
    nn = (e) => {
      ...
      return {
        ...
        __unsafeProperties: {
          ...(r.s && { s: !0 }),
          ...(r.enable_textapp && { enableTextApp: !0 }),
          group: {
            ...
            logo:
              "1" === r.group["chat_window.display_logo"]
                ...
                : { enabled: !1 },
            minimizedType: tn(r.group["chat_window.theme.minimized"], [
              "circle",
              "bar",
            ]),
            ...
            screenPosition: tn(r.group["chat_window.screen_position"], [
              "right",
              "left",
            ]),
            screenPositionOnMobile: tn(
            ...
            theme: {
              name: tn(r.group["chat_window.new_theme.name"], [
                "smooth",
                "modern",
              ]),
              variant: tn(r.group["chat_window.new_theme.variant"], [
                "light",
                "dark",
              ]),
            ...
            e.addEventListener(t, (n) => {
              ...
              const f = {
                ...
                currentTarget: {
                  ...
                  draggable:
                    null == (s = n.currentTarget) ? void 0 : s.draggable,
              ...
              if ("click" === t && "copy" === e.getAttribute(ln))
                return (
                  (g = e.getAttribute(dn)),
                  navigator.clipboard
                    ? navigator.clipboard.writeText(g).catch(rn)
                    : rn(g),
  ...
  const hn = (e) => {
      ...
      if (
        ...
        r = [].concat(
          ...
          Object.keys(
            ((c = Boolean),
            a((s = e)).reduce((e, t) => (c(s[t]) && (e[t] = s[t]), e), {}))
          )
        );
      }
      var c, s;
  ...
  const vn = (e, t) => we(gn(e, t), ze(1)),
    ...
    wn = { maximize: ["feature", "messageDraft"], minimize: [] },
    yn = (e, t) => {
      const n = e.target;
  ...
  let kn = null;
  const Cn = () => {
      if (kn) throw Error("Title notification service already initialized");
      kn = (() => {
        try {
    ...
    En = () => {
      if (!kn) throw Error("Title notification service not initialized");
      return kn;
    },
    xn = (e) => {
      var t, n;
      const i = ["http:", "https:"];
      return !i.includes(null != (t = re(e)) ? t : "") &&
        i.includes(null != (n = re(document.referrer)) ? n : "")
        ? document.referrer
        : e;
    },
    In = () => ({
      ...
      return (
        (t.get = function (e) {
          ...
          return new Mn.Promise(function (n) {
            ...
            t.parent.addEventListener(
              ...
              t.child.postMessage(
                { postmate: "request", type: An, property: e, uid: i },
                t.childOrigin
              );
          });
        }),
        (t.call = function (e, t) {
          this.child.postMessage(
            { postmate: "call", type: An, property: e, data: t },
            this.childOrigin
          );
        }),
        (t.on = function (e, t) {
      ...
      return (
        (e.prototype.emit = function (e, t) {
          this.parent.postMessage(
            { postmate: "emit", type: An, value: { name: e, data: t } },
            this.parentOrigin
          );
        }),
        e
        ...
        (e.prototype.sendHandshake = function (t) {
          ...
          return new e.Promise(function (e, a) {
            ...
            var c = function () {
                r++,
                  i.child.postMessage(
                    { postmate: "handshake", type: An, model: i.model },
                    o
                  ),
                  5 === r && clearInterval(n);
              },
            ...
            i.frame.attachEvent
              ? i.frame.attachEvent("onload", s)
              : i.frame.addEventListener("load", s),
              (i.frame.src = t);
          });
        }),
        e
                  ...
                  if ("handshake" === o.data.postmate) {
                    e.child.removeEventListener("message", i, !1),
                      o.source.postMessage(
                        { postmate: "handshake-reply", type: An },
                        o.origin
                      ),
      ...
      return (
        ...
        e.on("remote-call", (n) => {
          ...
          c && "function" == typeof c.then
            ? c.then((e) => {
                r("resolveRemoteCall", { id: i, value: e });
              })
            : r("resolveRemoteCall", { id: i, value: c });
        }),
        (e.emit = (e, t) => {
          r("emitEvent", { event: e, data: t });
        }),
        (e._emit = a.emit),
        (e.call = function (e) {
          for (
          ...
          return new Promise((t) => {
            const i = g(s);
            (s[i] = t), r("remoteCall", { id: i, method: e, args: n });
          });
        }),
        i(e, t)
      );
  ...
  function Vn(e) {
    return we(
      gn(e, (e) => Ve(e, Wn).active),
      ze(1),
      ke((t) =>
        t
          ? we(
              gn(e, (e) => Ve(e, Wn).properties.currentAgent),
              he(Boolean),
              be(() => t),
              Oe(1)
            )
  ...
  const Yn = () => window.GoogleAnalyticsObject || "ga",
    Jn = (e) => {
    ...
    $n = (e) => {
      ...
      if (t && "function" == typeof Xn[t]) return i && "ga" === t ? "gaAll" : t;
      if (
    ...
    ei = {
      ...
      mixpanel: () => {
        ...
        return (e) => {
          ...
          (i && (o.register(i), !Zn())) || (t in Qn && o.track(Qn[t], n));
        };
      },
    };
  var ti = (e, t) => {
    ...
    we(
      ...
      e.on("add_event", (e) => {
        ...
        t.invitation &&
          t.receivedFirstTime &&
          o("Automated greeting", { nonInteraction: !0 });
      }),
      e.on("on_chat_booster_launched", (e) => {
        let { id: t, title: n } = e;
        o("Chat Booster Launched: " + n, { eventData: { appId: t, title: n } });
      }),
      ...
      e.on("on_ticket_created", (e) => {
        ...
        o("Ticket form filled in", { eventData: { email: t } });
      }),
      ...
      ["prechat", "postchat", "ticket", "offline"].forEach((t) => {
        var n;
        we(
          ve(_e(e, "set_default_view"), _e(e, "set_current_view")),
          he(
            (e) =>
              e.viewInfo &&
                  ...
                  if (0 === t) {
                    ...
                    e(0, function (e, t) {
                      if (
                        ...
                        return s
                          ? void n(1, t)
                          : (i.push(t), i.length > c && i.shift(), void r(1));
                      n(e, t);
                    });
                  }
                };
      ...
      const e = ri().then((e) =>
        e
          ? P(
              e
                .filter((e) =>
                  _(".livechatinc.com", e.attribution[0].containerSrc)
                )
                .map((e) => e.duration)
            )
          : null
  ...
  const pi = ["America/", "Europe/"],
      ...
      const o = ((e) => {
          ...
          const n = e.getAttribute("aria-label"),
            i = {
              ...
              ...(e.id && { clickElementId: e.id }),
              ...(e.className && { clickElementClassNames: e.className }),
              ...((null == (t = e.textContent) ? void 0 : t.trim()) && {
                clickElementLabel: e.textContent.trim(),
              }),
              ...(n && { clickElementAriaLabel: n }),
            };
          return e instanceof HTMLAnchorElement
            ? { ...i, ...(e.href && { clickElementHref: e.href }) }
            : e instanceof HTMLButtonElement
            ? {
                ...i,
                ...(e.type && { clickElementType: e.type }),
                ...(e.name && { clickElementName: e.name }),
                ...(e.value && { clickElementValue: e.value }),
              }
            : i;
        })(i),
        r = In();
      t.call("logInfo", "button_click", { ...o, ...r });
    },
    hi = (e, t, n) => {
      const { actingAsDirectLink: i } = t;
      if (
        i ||
        !n.__unsafeProperties.s ||
        !(() => {
    ...
    gi = { 100: "#FF7C6B", 500: "#D93311" },
    vi = { 100: "#77Cf9D", 500: "#268750" },
    _i = { 100: "#FA6681", 500: "#E30D34" },
    wi = {
      0: "#FFFFFF",
      15: "#F6F6F7",
      25: "#F0F0F0",
  ...
  var yi = Object.freeze({
    ...
    grayscale: wi,
    brand: { orange: "#FF5100", black: "#1B1B20" },
  });
  const bi = {
      ...yi,
      border: wi[500],
  ...
  var Ci = Object.freeze({ __proto__: null, light: bi, dark: ki });
  const Ei = function (e, t) {
    ...
    Ti = (e, t) => {
      ...
      const o = G(
          l({
            ...(e.organizationId ? { organization_id: e.organizationId } : {}),
            ...(e.license ? { license_id: e.license } : {}),
            group: e.group,
        ...
        r = e.iframeAddress + "?" + o;
      function a(e) {
        Math.random() > 0.001 || t.call("logInfo", e);
      }
      const c = new BroadcastChannel(
          e.organizationId +
            (e.uniqueGroups && "number" == typeof e.group
              ? ":" + e.group
              : "") +
            ":detached_widget_visibility_broadcast_channel"
        ),
        s = d(300, async function () {
          if (
            ((i = await t.call("getPipConsent", e)),
            !document.hidden || "deny" === i || "dismissed" === i || !u)
          )
            return (u = !0), void (n && n.close());
          ...
          window.documentPictureInPicture
            ...
            .then((e) => {
              ...
              const { config: c, rtl: s } = Je(t.state);
              (e.document.body.style.backgroundColor =
                Ci[c.theme.variant].widgetBackground),
                (e.document.body.style.color =
                  Ci[c.theme.variant].primaryTextColor),
  ...
  var Pi = (e, t, n) => {
      ...
      const a = (e) => {
          ...
          return (
            n.hidden || "minimized" !== t.state || "online" !== i || o === D
          );
        },
        c = () => {
        ...
        s = () => {
          const o = nt("div", ut),
            r = xi(t);
          Xe({ bottom: i.y + "px", [r]: i.x + "px" }, o);
          const s = nt("div", pt);
          15 > i.x && "right" === r && Xe({ [r]: 10 - i.x + "px" }, s),
            (s.innerHTML = "&times;");
          const l = nt("div", mt),
            d = { ...ht, src: i.src, alt: n.embedded_chat_now };
          i.srcset &&
            (d.srcset = S(i.srcset)
              .map((e) => {
                let [t, n] = e;
  ...
  const Si = Ft(),
    Mi = (e, t) => {
      ...
      return (
        !t.region ||
          ("fra" !== t.region && "eu-west3" !== t.region) ||
          (n = n.replace("secure", "secure-fra")),
      ...
      return {
        ...
        hidden:
          ...
          (((e) => {
            ...
            return Si && t.hasCustomMobileSettings
              ? t.initiallyHiddenOnMobile
              : t.initiallyHidden;
          })(n) ||
            e.isMinimizedForcefullyDisabled),
  ...
  var Hi = (e, t) => {
    ...
    return (
      !!n &&
      []
        .concat(e, ["livechatinc.com", "lc.chat", "text.my", "text.at"])
        .some((e) => {
          const t = n.length - e.length;
          return (
            -1 !== n.indexOf(e.toLowerCase(), t) &&
  ...
  const Ri = function (e) {
      ...
      for (
        ...
        n[i - 1] = arguments[i];
      Vi.push({ name: e, args: n });
    },
    Gi = "always visible",
    Ui = "always hide",
    Ki = "hide until it gets activated";
  function Yi(e, t, n) {
    return function (i) {
      var o, r, c;
      ...
      const { trackerName: l } = t.analytics.googleAnalytics,
        ...
        p = a(gt.style).some(
          (t) => e.frame.style.getPropertyValue(t) !== gt.style[t]
        ),
        { desktopVisibility: m, mobileVisibility: h } = ((e) => {
          ...
          return (
            (c = r ? (t ? Ui : Ki) : Gi),
            (s = i ? (o ? Ui : a ? (n ? Ui : Ki) : Gi) : c),
            { desktopVisibility: c, mobileVisibility: s }
          );
        ...
        f = [
          ...
          [
            ...
            { msg: "tracker name: " + l },
            { msg: "desktop visibility: " + m, isNotStandard: m !== Gi },
            { msg: "mobile visibility: " + h, isNotStandard: h !== Gi },
            {
              msg:
                "chat between groups: " +
      ...
      const g = f.filter((e) => {
        ...
        _ = [].concat(g, v);
      return -1 !== u.indexOf("console.log")
        ? _.map((e) => {
            let { msg: t } = e;
            return t;
          }).join("\n\n")
  ...
  function Qi(e, t) {
    ...
    } else e.call("storeMethod", ["requestUpdateUser", Ke(e.state), t]);
  }
  function Zi(e, t) {
    e.call("storeMethod", ["requestSetUserProperties", Ke(e.state), t]);
  }
  function eo(e) {
  ...
  function io(e, t, n) {
    ...
    we(
      ...
      fe(() => no(i.on_chat_window_opened))
    ),
      we(
        Un(e, () =>
          (function (e) {
            return we(
              gn(e, (e) => qt(e, "minimized")),
              ze(1),
              he(b)
            );
          })(e)
        ),
        fe(() => no(i.on_chat_window_minimized))
      ),
      we(
        (function (e) {
          return we(
        ...
        fe(() => no(i.on_chat_window_hidden))
      ),
      we(
        Hn(e),
        fe((e) =>
          no(i.on_chat_state_changed, {
      ...
      we(
        ...
        he(b),
        fe(() =>
          no(i.on_chat_started, {
            agent_name: Ue(e.state, Ve(e.state, to).properties.currentAgent)
              .name,
          })
        )
      ),
      we(
        Un(e, () => Vn(e)),
        he(y),
        fe(() => no(i.on_chat_ended))
      ),
      we(
        Un(e, () => _e(e, "on_message")),
        fe((e) => no(i.on_message, e))
      ),
      we(
        _e(e, "widget_resize"),
        fe((e) => {
      ...
      we(
        (function (e) {
          return we(
            ...
            be((t) => {
              let { event: n } = t;
              return { event: n, author: Ue(e.state, n.author) };
            })
          );
        })(e),
        fe((e) => {
      ...
      (i.set_custom_variables = (t) => {
        Ri("LC_API.set_custom_variables", t), Zi(e, $i(t));
      }),
      (i.update_custom_variables = (t) => {
        Ri("LC_API.update_custom_variables", t), Qi(e, { properties: $i(t) });
      }),
      (i.set_visitor_name = (t) => {
        Ri("LC_API.set_visitor_name", t), Qi(e, { name: eo(t) });
      }),
      (i.set_visitor_email = (t) => {
        Ri("LC_API.set_visitor_email", t), Qi(e, { email: eo(t) });
      }),
      (i.open_chat_window =
        i.show_full_view =
      ...
      (i.agents_are_available = () => (
        Ri("LC_API.agents_are_available"),
        "online" === Je(e.state, "availability")
      )),
      (i.chat_window_maximized = () => (
        Ri("LC_API.chat_window_maximized"), qt(e.state, "maximized")
      )),
      (i.chat_window_minimized = () => (
        Ri("LC_API.chat_window_minimized"), qt(e.state, "minimized")
      )),
      (i.chat_window_hidden = () => (
        Ri("LC_API.chat_window_hidden"), qt(e.state, "hidden")
      )),
      (i.visitor_queued = () => (
        Ri("LC_API.visitor_queued"), Ve(e.state, to).properties.queued
      )),
      (i.chat_running = () => (
        Ri("LC_API.chat_running"), Ve(e.state, to).active
      )),
      (i.visitor_engaged = () => (
        Ri("LC_API.visitor_engaged"),
        i.visitor_queued() ||
          i.chat_running() ||
          !!Ve(e.state, to).properties.fakeAgentMessageId
      )),
      (i.get_window_type = () => (Ri("LC_API.get_window_type"), "embedded")),
      (i.close_chat = () => {
        Ri("LC_API.close_chat"),
          e.call("storeMethod", ["requestUpdateChat", to, { active: !1 }]);
      }),
      (i.diagnose = Yi(e, t, n)),
      (i.get_last_visit_timestamp = () => Je(e.state).clientLastVisitTimestamp),
      (i.get_visits_number = () => Je(e.state).clientVisitNumber),
      (i.get_page_views_number = () => Je(e.state).clientPageViewsCount),
      (i.get_chats_number = () => Je(e.state).clientChatNumber),
  ...
  const oo = {
      ...
      navigate(e, t) {
        void 0 === t && (t = "_blank"),
          jn(() => {
            window.location.origin === J(e) && "function" == typeof this.handler
              ? this.handler(te(e))
              : window.open(e, t);
          });
      },
    ...
    ao = (e) => {
      ...
      return (
        ...
        c(
          String,
          l({ ["__sales_tracker_" + t]: "1", __order_id: n, __order_price: i })
        )
      );
    },
    co = (e) => {
  ...
  function uo(e, t, n) {
    const i = Ht(),
      ...
      r = (e, t) => {
        var n;
        return (n = { get: v, call: w, on: h, once: f, off: i.off })[e].apply(
          n,
          t
        );
      },
    ...
    function m(t, n, o) {
      switch (n) {
        ...
        case "rich_message_button_clicked":
          return void i[t](n, o);
        case "ready":
          return void (Je(e.state, "readyState") !== D
            ? jn(() =>
                o({ state: g("state"), customerData: g("customer_data") })
              )
            : i[t](n, o));
        default:
          return void console.error(
    ...
    function g(t) {
      switch (t) {
        case "state": {
          const { availability: t, visibility: n } = Je(e.state);
    ...
    function w(n, i) {
      switch (
        (Ri.apply(void 0, ["LiveChatWidget.call", "'" + n + "'"].concat(i)), n)
      ) {
        case "hide":
        case "maximize":
        case "minimize":
        ...
        case "set_session_variables":
          return void Zi(e, c(String, i));
        case "set_customer_name":
          return void Qi(e, { name: eo(i) });
        case "set_customer_email":
          return void Qi(e, { email: eo(i) });
        case "update_session_variables":
          return void Qi(e, { properties: c(String, i) });
        case "trigger_sales_tracker":
          return void Zi(e, ao(i));
        case "hide_greeting":
    ...
    void 0 === (p = d.other) && (p = []),
      ...
      we(
        ...
        fe(() => {
          !(function () {
            ...
            a("ready", { state: g("state"), customerData: g("customer_data") });
        })
      ),
      we(
        Un(e, () => Hn(e)),
        fe((e) => a("availability_changed", { availability: e }))
      ),
      we(
        Un(e, () => vn(e, () => g("state").visibility)),
        fe((e) => {
          a("visibility_changed", { visibility: e });
        })
      ),
      we(
        Un(e, () => vn(e, () => g("customer_data").status)),
        fe((e) => a("customer_status_changed", { status: e }))
      ),
      we(
        Un(e, () => Kn(e, "hiddenIds")),
        be((t) => so(e, t)),
        he(b),
        fe((e) => a("greeting_hidden", co(e)))
      ),
      we(
        Un(e, () => Kn(e, "displayedIds")),
        be((t) => so(e, t)),
        he(b),
        fe((e) => a("greeting_displayed", co(e)))
      ),
      we(
        _e(e, "on_rating_submitted"),
        fe((e) => a("rating_submitted", e))
      ),
      we(
        ve(_e(e, "add_event"), _e(e, "send_event")),
        he((e) => {
          let { event: t } = e;
        ...
        be((t) => {
          ...
          return {
            ...
            author: {
              id: a.serverId,
              type: a.id === Ke(e.state) ? "customer" : "agent",
            },
            ...(c && { greeting: co(r) }),
          };
        }),
      ...
      we(
        ve(
          ...
          we(
            _e(e, "rich_greeting_button_clicked"),
            be((e) => {
              let { event: t, button: n } = e;
              const { id: i, properties: o } = t,
                { postbackId: r } = n;
              return { eventId: i, postbackId: r, greeting: co(o) };
            })
          )
        ),
      ...
      we(
        ve(
          we(
            _e(e, "on_ticket_created"),
            be(() => "ticket")
          ),
          we(
            _e(e, "on_prechat_survey_submitted"),
            be(() => "prechat")
          ),
          we(
            _e(e, "on_postchat_survey_submitted"),
            be(() => "postchat")
          )
        ),
        fe((e) => a("form_submitted", { type: e }))
      );
  }
  const po = {
  ...
  var mo = (e) => {
      ...
      const i = () => {
        const e = t.content,
          i =
            ((o = document.body),
            Object.keys(po).reduce((e, t) => ((e[t] = o.style[t]), e), {}));
        var o;
  ...
  const yo = Ft(),
    ...
    ko = (e, t, n) => {
      const i = Ii(t, yo);
      return !e && n
        ? { [xi(t, yo)]: "0", bottom: i.y + "px", maxHeight: "100%" }
        : yo && e
        ? { [xi(t, yo)]: "0", bottom: "0", maxHeight: "100%" }
        : {
            [xi(t, yo)]: i.x + "px",
            bottom: i.y + "px",
    ...
    xo = (e, t) => {
      ...
      return Xe({ width: r, height: a, [xi(e, yo)]: i.x + "px", ...o }, n), n;
    },
    Io = (e, t, n, i, o, r, a) => {
      var c, s;
      let d = G(
        l({
          ...(t.license && { license_id: t.license }),
          group: t.group,
          embedded: 1,
          widget_version: 3,
      ...
      const p = {
          ...
          resize(t) {
            ...
            const c = { width: i, height: o },
              s = ko(r, n, a);
            Xe({ ...c, ...s }, e.element);
            const l = Ze(["width", "height"], e.element);
            this._emit("widget_resize", { size: c, computedSize: l });
          },
          show() {
            Xe(lt, e.element);
          },
          ...
          renderCrossFrameMarkup(t) {
            ...
            o ||
              ...
              $e({ ..._t, title: "openwidget" === a ? ct : at }, o),
          ...
          renderLightboxMarkup(e) {
            ...
            (this.handleLightboxKeydown = (e) => {
              ...
              i ||
                ...
                i.focus(),
                jt() || (!Nt() && /Safari/.test(navigator.userAgent))
                  ? (i.onload = () => {
                      i.contentDocument.addEventListener(
                        "keydown",
                        this.handleLightboxKeydown
                      );
                    })
                  : i.contentDocument.addEventListener(
                      "keydown",
          ...
          removeLightboxMarkup() {
            ...
            e &&
              (this.handleLightboxKeydown &&
                (e.contentDocument.removeEventListener(
                  "keydown",
                  this.handleLightboxKeydown
                ),
        ...
        h = new MutationObserver((t) =>
          t.forEach((t) => {
            const n = u(
              (e) => "IFRAME" === e.tagName && e.getAttribute("src") === m,
              t.addedNodes
            );
            n &&
              ((e, t, n) => {
                $e({ ...gt, title: "openwidget" === n ? ct : at }, t),
                  e.custom || Xe(ft, t);
              })(e, n, a);
          })
        );
      h.observe(e.element, { childList: !0 });
      let f = !0;
      if ("openwidget" === a) {
        var g;
        f = !!(null == (g = n.features.find((e) => "forms" === e.name)) ||
        null == (g = g.properties) ||
        null == (g = g.templates)
          ? void 0
          : g.bugreport);
    ...
    Lo = (e, t, n, i, o, r) => {
          ...
          : (ho(e),
            "openwidget" === r &&
              ...
              ((e) => {
                const t = (t) => yn(t, e);
                we(
                  gn(e, (e) => e.application.readyState),
                  he((e) => e === F),
                  Oe(1),
                  fe(() => {
        ...
        "livechat" === r &&
          ("documentPictureInPicture" in window &&
            ((e) => {
              var t;
              return !!(null ==
              (t = e.properties.license.bb9e5b2f1ab480e4a715977b7b1b4279)
                ? void 0
                : t.detached_mode_enabled);
            })(o) &&
            Ti(t, e),
          ((e) => {
            const {
            ...
            let o = null,
              r = null;
            const a = we(
              ge(document, "visibilitychange"),
              he(() => "maximized" === Je(e.state).visibility.state),
              be(() => !document.hidden)
            );
            we(
              a,
              ...
              we(
                ...
                he((e) => {
                  ...
                  return (
                    "client_inactive" ===
                    (null == (t = n.properties) ? void 0 : t.systemMessageType)
                  );
                }),
                he(() => r && Ve(e.state, qi).properties.ended),
                Oe(1),
                fe(() => {
                  Math.floor(100 * Math.random()) ||
                    e.call("logInfo", "inactivity_duration", {
                      duration: r,
      ...
      t.actingAsDirectLink ||
        ...
        e.on("rich_greeting_button_clicked", (e) => {
          let { button: t } = e;
          "url" === t.type &&
            oo.navigate(t.value, "current" === t.target ? "_parent" : "_blank");
        }),
        ...
        e.on("register_exit_intent_listener", () => {
          const t = ((e, t) => {
            ...
            return (
              window &&
                (ji && window.removeEventListener("mouseout", ji),
      ...
      ((e) => {
        ...
        return Kt(
          "https://api.livechatinc.com/global-mapper/" +
            (t ? "lc_license_id/" + t : "organization_id/" + n) +
            "/region",
        ...
        Zt({ ...e, region: t }).then((t) => {
          return Promise.all([
            ...
            Kt(Qt("get_configuration", n), {
              callbackName: "lc_static_config",
              query: {
                organization_id: n.organizationId,
                version: n.version,
                ...Xt(n),
                ...("number" == typeof n.groupId && { group_id: n.groupId }),
              },
            }).then((e) => nn(e))),
          ]).then((e) => {
            let [t, n] = e;
  ...
  var To = (e, t) => {
    ...
    const {
      ...
      f = {
        ...(a ? { organizationId: a } : { licenseId: r }),
        skipCodeInstallationTracking: d,
        productName: p,
        integrationName: u,
      ...
      .then((e) => {
        ...
        g((e) => {
          (e.disable_sounds = L),
            ...
            (e.agents_are_available = () =>
              -1 !== o.onlineGroupIds.indexOf(o.groupId)),
            ...
            (e.update_custom_variables = (e) => {
              e && (h.properties = { ...h.properties, ...$i(e) });
            });
        });
        const _ = {
          ...u,
          ...(o.licenseId && { license: o.licenseId }),
          customer: { ...u.customer, ...h },
          hidden: u.hidden || f,
        ...
        p.custom || a.appendChild(p.element),
          ...
          Promise.all([
            Io(p, _, o, s, d, null, i),
            "openwidget" === i
              ? Promise.resolve(o.localization)
              : ((w = {
                ...
                }).then((e) => C((e) => e.toLowerCase(), e))),
          ])
            .then((e) => {
              let [t, n] = e;
              return (
                p.custom || Co(p.element),
                Lo(t, _, p, n, o, i),
                we(
                  gn(t, (e) => Je(e, "readyState")),
                  he((e) => e === F),
                  Oe(1),
                  be(() => t),
                  De
  ...
  function zo() {
    et().then((e) => {
      [
        "https://cdn.livechatinc.com/widget/static/js/configurator.BAKKWjQ3.js",
      ].forEach((t) => {
        ((e, t) => {
          const n = document.createElement("script");
          $e({ src: t, type: "module", charset: "utf-8" }, n), e.appendChild(n);
        })(e.ownerDocument.head, t);
      });
    });
  }
  const Po = (e, t) => {
      const n = { name: null, email: null, properties: {} };
        ...
        try {
          if (
            ...
            Array.from(document.getElementsByTagName("script")).find((e) => {
              var t;
              return null == (t = e.textContent)
                ? void 0
                : t.startsWith("window.__lc");
            })
          )
    ...
    So = () => {
      if (((window.__lc_inited = !0), "msCrypto" in window))
        return void console.error(
          "[LiveChat] We no longer support Internet Explorer"
        );
      ...
      const e = {
        ...
        organizationId:
          "string" == typeof t.organizationId ? t.organizationId : null,
        ...
        customIdentityProviderInitializer:
          "function" == typeof t.custom_identity_provider
            ? t.custom_identity_provider
            : null,
        iframeAddress: null,
        region: _(t.region, ((n = j), a(n).map((e) => n[e])))
          ? t.region + ""
          : null,
      };
      var t, n;
